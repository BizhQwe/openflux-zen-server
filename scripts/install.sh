...
TAG_URL="https://github.com/BizhQwe/openflux-zen-server/releases/download/v1.0.17/openflux-installer-$RID"
FALLBACK_URL="https://github.com/BizhQwe/openflux-zen-server/releases/download/v1.0.16/openflux-installer-$RID"
