...
TAG_URL="https://github.com/BizhQwe/openflux-zen-server/releases/download/v1.0.12/openflux-installer-$RID"
FALLBACK_URL="https://github.com/BizhQwe/openflux-zen-server/releases/download/v1.0.11/openflux-installer-$RID"
