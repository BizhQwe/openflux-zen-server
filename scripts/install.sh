...
TAG_URL="https://github.com/BizhQwe/openflux-zen-server/releases/download/v1.0.10/openflux-installer-$RID"
FALLBACK_URL="https://github.com/BizhQwe/openflux-zen-server/releases/download/v1.0.9/openflux-installer-$RID"
