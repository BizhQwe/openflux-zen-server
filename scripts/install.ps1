...
$tagUrl = "https://github.com/BizhQwe/openflux-zen-server/releases/download/v1.0.15/openflux-installer-$arch.exe"
$fallbackUrl = "https://github.com/BizhQwe/openflux-zen-server/releases/download/v1.0.14/openflux-installer-$arch.exe"
