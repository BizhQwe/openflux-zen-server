...
$tagUrl = "https://github.com/BizhQwe/openflux-zen-server/releases/download/v1.0.11/openflux-installer-$arch.exe"
$fallbackUrl = "https://github.com/BizhQwe/openflux-zen-server/releases/download/v1.0.10/openflux-installer-$arch.exe"
