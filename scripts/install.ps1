...
$tagUrl = "https://github.com/BizhQwe/openflux-zen-server/releases/download/v1.0.17/openflux-installer-$arch.exe"
$fallbackUrl = "https://github.com/BizhQwe/openflux-zen-server/releases/download/v1.0.16/openflux-installer-$arch.exe"
